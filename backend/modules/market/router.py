...
from core.config import DATA_DIR, resolver, iwencai_adapter
from modules.market.service import fetch_intraday_data
...
def get_daily_data(symbol: str, datalen: int = 30):
    ...
    try:
        from modules.market.service import fetch_daily_data
