<template>
  <div class="layer-content">
    <div v-if="isLoading" class="glass-panel p-8 flex flex-col items-center justify-center h-[400px]">
      <i class="fa-solid fa-circle-notch fa-spin text-4xl text-sky-400 mb-4"></i>
      <p class="text-gray-400">Loading fundamental data...</p>
    </div>

    <div v-else-if="errorMessage" class="glass-panel p-8 flex flex-col items-center justify-center h-[400px] border-red-500/30">
